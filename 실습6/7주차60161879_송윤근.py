...
def load_data():
    ...
    X_train_full, X_test, y_train_full, y_test = train_test_split(x_data, y_data, test_size=0.3)
...
def makemodel(X_train, y_train, X_valid, y_valid, weight_init):
    ...
    model.add(keras.layers.Flatten(input_shape=[64,]))
...
def main():
    ...
    X_valid, X_train, y_valid, y_train = data_normalization(X_train_full, y_train_full)
    # show_oneimg(X_train)
